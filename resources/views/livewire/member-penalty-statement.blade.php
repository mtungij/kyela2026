<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6 space-y-5">
    <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/30">
            <div class="text-sm text-gray-600 dark:text-gray-300">Tarehe Zilizofungwa</div>
            <div class="text-xl font-bold text-gray-900 dark:text-white">{{ $this->penaltySummary['closed_count'] }}</div>
        </div>
        <div class="p-4 rounded-lg bg-red-50 dark:bg-red-900/20">
            <div class="text-sm text-red-700 dark:text-red-300">Faini Zilizoandikwa</div>
            <div class="text-xl font-bold text-red-700 dark:text-red-300">{{ $this->penaltySummary['charged_count'] }}</div>
        </div>
        ...
        <div class="p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20">
            <div class="text-sm text-blue-700 dark:text-blue-300">Faini Zilizosamehewa</div>
            <div class="text-xl font-bold text-blue-700 dark:text-blue-300">{{ $this->penaltySummary['forgiven_count'] }}</div>
        </div>
        <div class="p-4 rounded-lg bg-orange-50 dark:bg-orange-900/20">
            <div class="text-sm text-orange-700 dark:text-orange-300">Faini Bado</div>
            <div class="text-xl font-bold text-orange-700 dark:text-orange-300">{{ $this->penaltySummary['unpaid_count'] }}</div>
        </div>
    </div>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                            Hakuna taarifa ya Funga Hesabu kwa mwanachama huyu.
                        </td>
                    </tr>
                @endforelse
            </tbody>
