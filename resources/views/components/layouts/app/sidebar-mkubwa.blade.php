...
<body class=" bg-white dark:bg-zinc-800 ">
    ...
    <flux:sidebar sticky collapsible="mobile" class=" bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700">
        ...
        <flux:sidebar.nav>
            <flux:sidebar.item icon="home" href="{{ route('dashboard') }}" current>Home</flux:sidebar.item>
               ...
               :expanded="false" heading="Members - Mkubwa"  class="grid">
                <flux:sidebar.item  badge="{{ App\Models\Member::where('pay_type', 'mchango_mkubwa')->count() }}" href="{{ route('members.index.mkubwa') }}" >Mchango Mkubwa</flux:sidebar.item>
    ...
    :expanded="false" heading="Reports" icon="chart-bar" class="grid">
                <flux:sidebar.item href="{{ route('daily.report') }}">Funga Hesabu</flux:sidebar.item>
                 ...
                 <flux:sidebar.item href="{{ route('daily.report') }}">Hesabu</flux:sidebar.item>
