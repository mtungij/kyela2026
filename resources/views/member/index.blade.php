<x-layouts.app :title="__('Members')">
    ...
    <div class="w-full px-4 lg:px-12">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
           ...
           <div class="w-full grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-3">

             
                        @if($members->isEmpty())
                            <tr>
                                <td colspan="11" class="px-4 py-3 text-center text-gray-500 dark:text-gray-400">Hamna member Kwa sasa.</td>
                            </tr>
                        @endif
    ...
    <div class="w-full h-full py-20 flex flex-wrap justify-center items-center gap-2">
        ...
        <div
            class="w-[20rem] mx-auto flex flex-col gap-2 px-4 shadow-lg border border-gray-300 border-gray-300 rounded-lg bg-white dark:bg-gray-900">
            <div class="w-full flex justify-center items-center">
                <img class="w-[8rem] h-[8rem] rounded-full outline outline-offset-2 outline-1 outline-blue-400 relative -top-[4rem]" src="{{ asset('images/member.png') }}" alt="Brothers" />
            </div>
...
@foreach($members as $member)
<div id="editModal-{{ $member->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
